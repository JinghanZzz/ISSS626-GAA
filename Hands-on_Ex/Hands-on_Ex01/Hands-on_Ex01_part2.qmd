...
```{r}
popdata <- read_csv("C:/JinghanZzz/ISSS608-VAA/Hands-on_Ex/Hands-on_Ex01/data/aspatial/respopagesextod2011to2020.csv")
```
...
```{r}
write_rds(mpsz_pop2020, "C:/JinghanZzz/ISSS608-VAA/Hands-on_Ex/Hands-on_Ex01/data/rds/mpszpop2020.rds")
```
